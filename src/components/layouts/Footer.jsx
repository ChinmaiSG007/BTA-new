...
const Footer = () => {
  ...
  return (
    <footer className="bg-neutral-800/80 text-white pt-16 pb-8">
            ...
            <ul className="space-y-2">
              {regions.map((region) => (
                region.tours.map((tour, index) => (
                  <li key={index}><Link to="/tours" className="text-neutral-300 hover:text-white">{tour.name}</Link></li>
                ))
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <a href="https://maps.app.goo.gl/RHvNxfjpej3cZ3VG8" target="_blank" className="text-neutral-300">Beyond Tarmac Adventures 92/2, 23rd cross, 16th main BTM 2nd stage, Benagluru- 560076
                </a>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-primary-400 mt-1 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="tel:+91-9663299663" className="text-neutral-300">+91 9663299663</a>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-primary-400 mt-1 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <a href="tel:+91-7259128123" className="text-neutral-300">+91 7259128123</a>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-primary-400 mt-1 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:info@beyondtarmacadv.com" className="text-neutral-300">info@beyondtarmacadv.com</a>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-primary-400 mt-1 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
